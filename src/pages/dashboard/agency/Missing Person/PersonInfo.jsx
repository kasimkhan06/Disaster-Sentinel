...
const FoundForm = ({ open, handleClose, personId }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Data.append(
        "agency_current_location_of_person",
        formData.agency_current_location_of_person
      );
...
function PersonInfo() {
  ...
  useEffect(() => {
    ...
    if (storedUser) {
      ...
      // Check permissions and set showButton
      const canEditMissing = permissions.some((perm) => perm.can_edit_missing);
      setShowButton(canEditMissing);
    }
  }, []);
                ...
                {[
                  {
                    ...
                    icon: <Person sx={{ color: "#5C6BC0" }} />,
                  },
                  {
                    label: "Age",
                    value: person.age,
                    icon: <CalendarToday sx={{ color: "#42A5F5" }} />,
                  },
                  {
                    label: "Gender",
                    value: person.gender,
                    icon: <Wc sx={{ color: "#26A69A" }} />,
                  },
                  {
                    label: "Missing Date",
                    value: `${getMissingDate(person.missingDate).date} at ${
                      getMissingDate(person.missingDate).time
                    }`,
                    icon: <History sx={{ color: "#1E88E5" }} />,
                  },
                  {
                    label: "Last Seen",
                    value: person.lastSeenLocation,
                    icon: <LocationOn sx={{ color: "#E57373" }} />,
                  },
                  {
                    label: "Identification Mark",
                    value: person.identification_marks,
                    icon: <Visibility sx={{ color: "#FBC02D" }} />,
                  },
                  {
                    label: "Description",
                    value: person.description,
                    icon: <Description sx={{ color: "#757575" }} />,
                  },
                ].map((item, index) => (
                  <Box
                    key={index}
                  ...
                  >
                    ...
                    <Typography
                      sx={{ ml: 1, fontSize: { xs: "0.85rem", md: "1rem" } }}
                    >
                      {item.value}
                    </Typography>
                  </Box>
